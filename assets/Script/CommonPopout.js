cc.Class({
    ...
    onLoad () {
        cc.changit.Utils.addClickEvent(this.confirmBtn, this.node, "CommonPopout", "onBtnClicked");
        cc.changit.Utils.addClickEvent(this.cancelBtn, this.node, "CommonPopout", "onBtnClicked");
    },
    ...
    onDestroy() {
        cc.changit.UIManager.destroyNode("CommonPopout");
    }
});
